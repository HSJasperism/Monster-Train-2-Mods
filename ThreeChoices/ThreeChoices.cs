...
namespace ThreeChoices
{
    ...
    public static class ThreeChoicesHelpers
    {
    ...
    {
        internal static void Prefix(RelicDraftRewardData __instance) => __instance.UpdateHerzalHoard();
    }
    ...
    {
        internal static void Prefix(DraftRewardData __instance) => __instance.UpdateBanner();
    }
}